      ...
      <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-2 w-full sm:w-auto overflow-hidden">
          ...
          <input type="date" v-model="selectedDate" @change="load"
            class="flex-1 rounded-xl px-3 py-2 text-sm text-white border focus:outline-none"
            style="background:#1a1a1a;border-color:#2a2a2a;color-scheme:dark;min-width:0;width:0"
          />
